import { Card, Checkbox, IconButton, Typography, Box, Stack, Chip, Menu, MenuItem, ListItemIcon, ListItemText, Button, Collapse, CardActionArea } from "@mui/material";
import { Check, MoreVert, AccessTime, EditOutlined, ContentCopy, DeleteOutline, ExpandMore, ExpandLess, Add } from "@mui/icons-material";
                ...
                >
                    ...
                    <Box sx={{ flexGrow: 1 }}>
                        ...
                        <Stack direction="row" flexWrap="wrap" gap={1} alignItems="center">
                            ...
                            {progress && (
                                <Box component="span" sx={{ bgcolor: '#ede9fe', color: '#7c3aed', px: 1.5, py: 0.25, borderRadius: 99, fontSize: '0.75rem', fontWeight: 700 }}>
                                    {progress}
                                </Box>
                            )}
                        ...
                        {subtasks.map((subtask) => (
                            ...
                            >
                                <Checkbox
                                    ...
                                    icon={<Box sx={{ width: 22, height: 22, borderRadius: 1, border: '2px solid', borderColor: 'grey.300', bgcolor: 'white' }} />}
                                    checkedIcon={
                                        <Box sx={{ width: 22, height: 22, borderRadius: 1, bgcolor: '#6366f1', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
